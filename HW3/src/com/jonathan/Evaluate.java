...
public class Evaluate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path outputAveragesFilePath = Paths.get(outputPath + "/hw3-5a-jhhchen.csv");
        ...
        if (!Files.exists(outputAveragesFilePath)) {
            outputAveragesWriter = new FileWriter(outputPath + "/hw3-5a-jhhchen.csv");
        ...
        // Otherwise append to the existing csv
             ...
             outputAveragesWriter = new FileWriter(outputPath + "/hw3-5a-jhhchen.csv", true);
             averagesBw = new BufferedWriter(outputAveragesWriter);
        }
